        ...
        <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === 'ios' ? 'padding' : undefined }>
            <ImageBackground 
                ...
                <View style={styles.main}>
                    ...
                    <View>
                        <Text style={styles.title}>Sua fonte de consulta na estrada.</Text>
                        <Text style={styles.description}>Ajudamos os caminhoneiros com informações e dicas em sua jornada diária.</Text>
                    </View>
                </View>
